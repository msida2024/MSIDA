...
class Awareness(nn.Module):
    def __init__(self, channels, factor=8):
        ...
        self.conv1x1_up = nn.Conv2d(channels // self.groups, 2 * (channels // self.groups), kernel_size=1, stride=1,
                                 padding=0)   
        self.conv3x3_mid = nn.Conv2d(2 * (channels // self.groups), 2 * (channels // self.groups), kernel_size=3, stride=1,
                                 padding=1)  
    ...
    def forward(self, x):
        ...
        x2 = group_x + self.conv3x3(group_x)
        # x2 = self.conv1x1_down(self.conv3x3_mid(self.conv1x1_up(group_x)))
...
class ResNet(Backbone):
    ...
    def __init__(self, stem, stages, num_classes=None, out_features=None, freeze_at=0):
        ...
        for i, blocks in enumerate(stages):
            ...
            self.Awareness[name] = Awareness(self._out_feature_channels[name])
    ...
    def forward(self, x):
        ...
        for name, stage in zip(self.stage_names, self.stages):
            ...
            if name in self._out_features:
                outputs[name] = self.Awareness[name](x)
